...
$min_start_rates['reverse']['first_buy']=1;
$min_start_rates['reverse']['first_buy_diff']=0.5;
...
//1. MARKET = KRAKEN
// 1 MARKET PİYASA XXBTZEUR yani BTCEUR

$market_data[0]['market']="Kraken";
$market_data[0]['coin1']="XETH";
$market_data[0]['coin2']="ZEUR";
$market_data[0]['pairs']="XETHZEUR";
...
$market_data[1]['coin1']="ETH";
$market_data[1]['coin2']="TRY";
$market_data[1]['pairs']="ETHTRY";
...
$control_time=date('Y-m-d H:i:s',strtotime('+100 minute',strtotime($cur_rates['CURTIME'])));
if($control_time<$now){
  ...
  $json_return_params['status']="CUR RATE TIMEOUT";
...
//  send_slack_message($e->getMessage(), 'info', 'info' );
  $json_return_params["status"]=$e->getMessage();
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
...
//  send_slack_message("BTCTURK CONNECT API PROBLEM", 'info', 'info' );
  $json_return_params["status"]="BTCTURK CONNECT API PROBLEM";
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
...
try {
  ...
  $saymayi_bitir = acilma_suresi();
  $basla = $saymayi_bitir - $saymaya_basla;
  $json_return_params["status"]="Account Balance Connection Problem M1";
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
...
$btcturk_balances=$btcturk_connect->getBalances();
  ...
  $saymayi_bitir = acilma_suresi();
  $basla = $saymayi_bitir - $saymaya_basla;
  $json_return_params["status"]="Account Balance Connection Problem M2";
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
...
try {
  ...
  $saymayi_bitir = acilma_suresi();
  $basla = $saymayi_bitir - $saymaya_basla;
  $json_return_params["status"]="M1 Prices Get Problem";
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
...
try {
  ...
  $saymayi_bitir = acilma_suresi();
  $basla = $saymayi_bitir - $saymaya_basla;
  $json_return_params["status"]= "M2 Prices Get Problem";
  $json_return_params["result"]="false";
  $wallet_params[$market_data[0]['market']][$market_data[0]['coin1']]['act_balance'] ="";
  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  $gain_rates['straight']['normal']="";
