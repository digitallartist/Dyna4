...
$min_start_rates['reverse']['normal']=1.6;
$min_start_rates['reverse']['first_buy']=1.6;
...
//1. MARKET = KRAKEN
// 1 MARKET PİYASA XLTCZUSD yani BTCEUR

$market_data[0]['market']="Kraken";
$market_data[0]['coin1']="XLTC";

$market_data[0]['coin2']="ZUSD";
$market_data[0]['pairs']="XLTCZUSD";
$market_data[0]['pairs2']="XLTC_ZUSD";
$market_data[0]['minumum_order']=0.1;
...
$market_data[1]['pairs2']="LTC_TRY";
$market_data[1]['minumum_order']=0.1;
