...
$market_data[0]['pairs1']="XXBTZUSD";
$market_data[0]['pairs2']="XETHZUSD";
$market_data[0]['pairs3']="XLTCZUSD";
$market_data[0]['pairs4']="XXRPZUSD";
$market_data[0]['pairs5']="XXLMZUSD";
$market_data[0]['pairs6']="USDTZUSD";
...
$market_data[1]['pairs1']="BTCTRY";
$market_data[1]['pairs2']="ETHTRY";
$market_data[1]['pairs3']="LTCTRY";
$market_data[1]['pairs4']="XRPTRY";
$market_data[1]['pairs5']="XLMTRY";
$market_data[1]['pairs6']="USDTTRY";
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs1'];
$market_data[0]['coin1']=substr($market_data[0]['pairs1'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs1'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs1'];
$market_data[1]['coin1']=substr($market_data[1]['pairs1'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs1'], -3);
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs2'];
$market_data[0]['coin1']=substr($market_data[0]['pairs2'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs2'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs2'];
$market_data[1]['coin1']=substr($market_data[1]['pairs2'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs2'], -3);
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs4'];
$market_data[0]['coin1']=substr($market_data[0]['pairs4'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs4'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs4'];
$market_data[1]['coin1']=substr($market_data[1]['pairs4'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs4'], -3);
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs3'];
$market_data[0]['coin1']=substr($market_data[0]['pairs3'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs3'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs3'];
$market_data[1]['coin1']=substr($market_data[1]['pairs3'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs3'], -3);
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs5'];
$market_data[0]['coin1']=substr($market_data[0]['pairs5'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs5'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs5'];
$market_data[1]['coin1']=substr($market_data[1]['pairs5'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs5'], -3);
...
$price_get=0;
$market_data[0]['pairs']=$market_data[0]['pairs6'];
$market_data[0]['coin1']=substr($market_data[0]['pairs6'], 0, -4);
$market_data[0]['coin2']=substr($market_data[0]['pairs6'], -4);

$market_data[1]['pairs']=$market_data[1]['pairs6'];
$market_data[1]['coin1']=substr($market_data[1]['pairs6'], 0, -3);
$market_data[1]['coin2']=substr($market_data[1]['pairs6'], -3);
