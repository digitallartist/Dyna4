...
require_once("includes/functions_all.php");
...
$min_start_rates['straight']['normal']=5;
$min_start_rates['straight']['first_sell']=5;
$min_start_rates['straight']['first_sell_diff']=0;
$min_start_rates['reverse']['normal']=0.6;
$min_start_rates['reverse']['first_buy']=0.6;
...
$market_data[0]['coin1']=$m1_coin;
$market_data[0]['coin2']="USD";
$market_data[0]['pairs']=$m1_coin."USD";
$market_data[0]['pairs2']=$m1_coin."_USD";
$market_data[0]['minumum_order']=20;
...
$market_data[1]['coin1']=$m2_coin;
$market_data[1]['coin2']="TRY";
$market_data[1]['pairs']=$m2_coin."TRY";
$market_data[1]['pairs2']=$m2_coin."_TRY";
$market_data[1]['minumum_order']=20;
...
echo "<br/>"."CUR RATE TIMEOUT YOU MUST RUN IT!"."<br/>";
...
//  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  ...
  //print_json_results($basla);
echo "<br/>"."M1 CONNECT API PROBLEM"."<br/>";
  exit();
}
...
//  send_slack_message("BTCTURK CONNECT API PROBLEM", 'info', 'info' );
  ...
  //print_json_results($basla);
echo "<br/>"."M2 CONNECT API PROBLEM"."<br/>";
}
...
if($m1_update==1){
    ...
    //  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
      ...
      $json_return_params['slack_status']=0;
       // print_json_results($basla);
       echo "<br/>"."Account Balance Connection Problem M1"."<br/>";
    }
...
if($m2_update==1){
    ...
    $btcturk_balances=$btcturk_connect->getBalances();
      ...
      $json_return_params['slack_status_api']="CYCLE_WARNINGS";
      $json_return_params['slack_status']=0;
      echo "<br/>"."Account Balance Connection Problem M2"."<br/>";
      //  print_json_results($basla);
      }
...
//  $wallet_params[$market_data[1]['market']][$market_data[1]['coin1']]['act_balance']="";
  ...
  //print_json_results($basla);
  echo "<br/>"."M1 Prices Get Problem"."<br/>";
}
...
try {
  ...
  //print_json_results($basla);
  echo "<br/>"."M2 Prices Get Problem"."<br/>";
}
...
$gain_rates['straight']['price']=$json_return_params['market1_bid_price'];
$gain_rates['reverse']['price']=$json_return_params['market2_ask_price'];
$gain_rates['straight']['usdtry']=$cur_rates['USDTRY'];
/*

echo " -> " . print_ytl($json_return_params['market1_bid_price'],2,'USD');
echo "<br/>";


$bb1="";
$bb2="";
if($gain_rates['straight']['normal']>2){
  $bb1="<b>";
  $bb2="</b>";
}
echo $bb1. $gain_rates['straight']['normal'] . $bb2 . "<br/>";


$bb1="";
$bb2="";

if($gain_rates['reverse']['normal']>2){
  $bb1="<b>";
  $bb2="</b>";
}

echo $bb1. $gain_rates['reverse']['normal'] . $bb2 . "<br/>";

echo " --> " .  print_ytl($json_return_params['market2_ask_price'],2,'TL') . " " ;
*/

echo json_encode($gain_rates)."\n";
/*
echo "<br/>
