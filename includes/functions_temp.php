...
echo "Değerler : ".$pairs . ", " . $orderMethod. ", " . $act_type. ", " . $price. ", " . $volume . "<br/> " ;
 try{
      $btcturk_order_response=$btcturk_connect->placeOrder($pairs, $orderMethod, $act_type, $price, 1,  0);
		echo "burda: <br/>" ;
		echo $btcturk_order_response->message . "<br/>";
		var_dump($btcturk_order_response);
