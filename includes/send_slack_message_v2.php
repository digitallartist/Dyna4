...
//dyna_warnings
define('DYNA_WARNINGS', 'https://hooks.slack.com/services/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');
...
function slack($txt) {
  ...
  curl_close($c);
	...
	function send_slack_message($text, $sender='DYNA_WARNINGS', $attachments=array() ){
	$data = array();
	$data["text"]=$text;
...
//  echo $data_string;
  ...
  if($sender=="DYNO_CYCLE")
     ...
     else if($sender=="DYNA_WARNINGS")
        $c = curl_init(DYNA_WARNINGS);
