...
*/
    ...
    foreach( @$datas as $data){
      ...
      $q ="UPDATE markets
      SET need_balance_update=0, try_num=0,  last_balanced_update_time='" . date("Y-m-d H:i:s") . "'
      WHERE id='2'";
      $r = mysqli_query ($dbc, $q); // Run the query.
        ...
        */
          ...
          */
            ...
            /*  echo "başla <br/>
			   ...
			   */
			   if($market_data[1]['pairs']=='XTZTRY' || $market_data[1]['pairs']=='DOTTRY'){
...
//
 ...
 try{
      ...
      $q ="UPDATE markets
      SET need_balance_update=1, need_balance_time='" . date("Y-m-d H:i:s") . "'
      WHERE id='2'";
      $r = mysqli_query ($dbc, $q); // Run the query.
