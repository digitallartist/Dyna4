  ...
  if($starting_values['All']['TRY']>0 )
{
  if($wallet_params['All'][$m2_fiat_money]['whole_balance']>$fiat_must_be)
  {
       ...
       echo $m2 . " -> " . $m2_fiat_money . " -> " . " ALARM - MANUAL DEPOSIT /  BALANCE " . " = >>" . print_ytl($alarm_rates[$m2]['FIAT']['alarm'],2,'%') . " > " .  print_ytl($fiat_money_status[$m2]['percent'],2,'%');
        ...
        $attachments[0]["fields"][o]["title"]="ALARM - MANUAL DEPOSIT REQUIRED";
        $attachments[0]["fields"][0]["value"]=$m2 ." -> ". $m2_fiat_money ." -> " . print_ytl($fiat_money_status[$m2]['percent'],2,'%');
       ...
       $attachments[0]["fields"][0]["title"]="WARNINNG - MANUAL DEPOSIT REQUIRED";
       $attachments[0]["fields"][0]["value"]=$m2 ." -> ". $m2_fiat_money ." -> " . print_ytl($fiat_money_status[$m2]['percent'],2,'%');
     ...
     echo "<br/>";
          ...
          $attachments[0]["fields"][0]["title"]="ALARM - MANUAL DEPOSIT REQUIRED";
          ...
          $attachments[0]["fields"][0]["title"]="WARNING - MANUAL DEPOSIT REQUIRED";
          $attachments[0]["fields"][0]["value"]=$m1 ." -> ". $m1_fiat_money ." -> " . print_ytl($fiat_money_status[$m1]['percent'],2,'%');
          $attachments[0]["fields"][0]["short"]=true;
            send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
  ...
  if($wallet_params[$m2][$m2_cypto_moneys[$i]]['whole_balance']>$m2_must_be)
  {
    ...
    if($alarm_rates[$m2]['CYPTO']['alarm']>$cypto_money_status[$m2][$m2_cypto_moneys[$i]]['percent']) {
      echo $m2 . " -> " . $m2_cypto_moneys[$i] . " -> " . " ALARM - WITHDRAW WAS STARTED AUTOMATICLY " . " = >>" . print_ytl($alarm_rates[$m2]['CYPTO']['warning'],2,'%') . " > " .  print_ytl($cypto_money_status[$m2][$m2_cypto_moneys[$i]]['percent'],2,'%');
        ...
        $attachments[0]["color"]="#990000";
        $attachments[0]["text"]=$m2 . " CRYPTO PROBLEMS"; 
      

      $attachments[0]["fields"][0]["title"]="ALARM - WITHDRAW WAS STARTED AUTOMATICLY";
      $attachments[0]["fields"][0]["value"]=$m2 ." -> ". $m2_cypto_moneys[$i] ." -> " . print_ytl($cypto_money_status[$m2][$m2_cypto_moneys[$i]]['percent'],2,'%');
      $attachments[0]["fields"][0]["short"]=false;
    send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
      ...
      $attachments[0]["fields"][0]["title"]="WARNING - AUTO WITHDRAW CAN FIX THE PROBLEM";
      $attachments[0]["fields"][0]["value"]=$m2 ." -> ". $m2_cypto_moneys[$i] ." -> " . print_ytl($cypto_money_status[$m2][$m2_cypto_moneys[$i]]['percent'],2,'%');
      $attachments[0]["fields"][0]["short"]=false;
      send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
    ...
    $attachments[0]["fields"][0]["title"]="PROBLEM - MISSING COINS";
    $attachments[0]["fields"][0]["value"]=$m2 ." -> ". $m2_cypto_moneys[$i] ." -> " . print_ytl($cypto_money_status[$m2][$m2_cypto_moneys[$i]]['percent'],2,'%');
    $attachments[0]["fields"][0]["short"]=false;
  send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
    ...
    if($wallet_params[$m1][$m1_cypto_moneys[$i]]['whole_balance']>$m1_must_be)
    {
      if($alarm_rates[$m1]['CYPTO']['alarm']>$cypto_money_status[$m1][$m1_cypto_moneys[$i]]['percent']) {
        echo $m1 . " -> " . $m1_cypto_moneys[$i] . " -> " . " ALARM -  MANUAL WITHDRAW REQUIRED" . " = >>" . print_ytl($alarm_rates[$m1]['CYPTO']['warning'],2,'%') . " > " .  print_ytl($cypto_money_status[$m1][$m1_cypto_moneys[$i]]['percent'],2,'%');
          ...
          $attachments[0]["color"]="#990000";
          $attachments[0]["text"]=$m1 . " CRYPTO PROBLEMS"; 
    
    
        $attachments[0]["fields"][0]["title"]="ALARM - MANUAL WITHDRAW REQUIRED";
        $attachments[0]["fields"][0]["value"]=$m1 ." -> ". $m1_cypto_moneys[$i] ." -> " . print_ytl($cypto_money_status[$m1][$m21cypto_moneys[$i]]['percent'],2,'%');
        $attachments[0]["fields"][0]["short"]=false;
        send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
        ...
        $attachments[0]["fields"][0]["title"]="WARNING - MANUAL WITHDRAW CAN BE MADE";
        $attachments[0]["fields"][0]["value"]=$m1 ." -> ". $m1_cypto_moneys[$i] ." -> " . print_ytl($cypto_money_status[$m1][$m21cypto_moneys[$i]]['percent'],2,'%');
        $attachments[0]["fields"][0]["short"]=false;
        send_slack_message(' ' , 'DYNA_WARNINGS', $attachments);
