...
/*
  ...
  $dbhost = 'localhost';
           $dbuser = 'musterdi_para';
           $dbpass = '447426me++';
           $dbname = 'musterdi_koin';
           $conn = mysqli_connect($dbhost, $dbuser, $dbpass,$dbname);

  $qq="SELECT * FROM gain_control WHERE fld_active='1'";
  ...
  $coin_totals[$i]['USD']['cash_eq']=$wallet_params['Kraken']['ZUSD']['whole_balance']+($wallet_params['BtcTurk']['TRY']['whole_balance']/$cur_rates['USDTRY'])+($wallet_params['Kraken']['ZEUR']['whole_balance']*($cur_rates['EURTRY']/$cur_rates['USDTRY']));
//  $coin_totals[$i]['USD']['coin']=$row['COINS_USD_EQ'];
  ...
  $coin_totals[$i]['EUR']['cash_eq']=$wallet_params['Kraken']['ZEUR']['whole_balance']+($wallet_params['BtcTurk']['TRY']['whole_balance']/$cur_rates['EURTRY'])+($wallet_params['Kraken']['ZUSD']['whole_balance']*($cur_rates['USDTRY']/$cur_rates['EURTRY']));
  ...
  $coin_totals[$i]['TRY']['coin_cash_eq']=$coin_totals[$i]['BTC']['whole_balance'] * $btcturk_prices['BTCTRY'] +
    ...
    $coin_totals[$i]['USDT']['whole_balance'] * $btcturk_prices['USDTTRY'] ;
    ...
    $html="";
      ...
      if($key%2==0)
                  ...
                  if($xlm_diff_0!=0)
                    ...
                    if($usdt_diff_0!=0)
                      ...
                      if($coin_cash_diff_0!=0)
                        $coin_cash_diff_0_text='<br/>' . print_ytl($coin_cash_diff_0,2,'');
                        ...
                        if($total_cash_diff_0!=0)
                          $total_cash_diff_0_text='<br/>' . print_ytl($total_cash_diff_0,2,'');
                      ...
                      if($xlm_diff_1!=0)
                        ...
                        if($usdt_diff_1!=0)
                          ...
                          if($coin_cash_diff_1!=0)
                            $coin_cash_diff_1_text='<br/>' . print_ytl($coin_cash_diff_1,2,'');
                            ...
                            if($total_cash_diff_1!=0)
                              $total_cash_diff_1_text='<br/>' . print_ytl($total_cash_diff_1,2,'');
        ...
        $html .='<div class="Row ' . $rowi_class . '">
            ...
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['EUR']['whole_balance'],2,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['EUR']['price'],2,'').  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['USD']['whole_balance'] ,2,'') . '</b><br/>Fyt: '. print_ytl($cur_param['USD']['price'],2,'').  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['TRY']['whole_balance'] ,2,'') . '</b></p>
            </div>
            <div class="Cell">
            ...
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['BTC']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['BTC']['price'],2,''). $btc_diff_0_text . $btc_diff_1_text .  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['ETH']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['ETH']['price'],2,''). $eth_diff_0_text . $eth_diff_1_text .  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['LTC']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['LTC']['price'],2,''). $ltc_diff_0_text . $ltc_diff_1_text .  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['XRP']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['XRP']['price'],2,''). $xrp_diff_0_text . $xrp_diff_1_text .  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['XLM']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['XLM']['price'],2,''). $xlm_diff_0_text . $xlm_diff_1_text .  '</p>
            </div>
            <div class="Cell">
                  <p><b>' . print_ytl($cur_param['USDT']['whole_balance'],8,'')  . '</b><br/>Fyt: '. print_ytl($cur_param['USDT']['price'],2,''). $usdt_diff_0_text . $usdt_diff_1_text .  '</p>
            </div>
