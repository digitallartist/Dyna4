...
//  print_r($wallet_params);
  $coin_totals[0]['BTC']['whole_balance']=$wallet_params['Kraken']['XXBT']['whole_balance']+$wallet_params['BtcTurk']['BTC']['whole_balance'];
  $coin_totals[0]['BTC']['avaiable_balance']=$wallet_params['Kraken']['XXBT']['avaiable_balance']+$wallet_params['BtcTurk']['BTC']['avaiable_balance'];
  $coin_totals[0]['BTC']['reserved_balance']=$wallet_params['Kraken']['XXBT']['reserved_balance']+$wallet_params['BtcTurk']['BTC']['reserved_balance'];
  $coin_totals[0]['BTC']['price']=$btcturk_prices['BTCTRY'];

  $coin_totals[0]['ETH']['whole_balance']=$wallet_params['Kraken']['XETH']['whole_balance']+$wallet_params['BtcTurk']['ETH']['whole_balance'];
  $coin_totals[0]['ETH']['avaiable_balance']=$wallet_params['Kraken']['XETH']['avaiable_balance']+$wallet_params['BtcTurk']['ETH']['avaiable_balance'];
  $coin_totals[0]['ETH']['reserved_balance']=$wallet_params['Kraken']['XETH']['reserved_balance']+$wallet_params['BtcTurk']['ETH']['reserved_balance'];
  $coin_totals[0]['ETH']['price']=$btcturk_prices['ETHTRY'];

  $coin_totals[0]['LTC']['whole_balance']=$wallet_params['Kraken']['XLTC']['whole_balance']+$wallet_params['BtcTurk']['LTC']['whole_balance'];
  $coin_totals[0]['LTC']['avaiable_balance']=$wallet_params['Kraken']['XLTC']['avaiable_balance']+$wallet_params['BtcTurk']['LTC']['avaiable_balance'];
  $coin_totals[0]['LTC']['reserved_balance']=$wallet_params['Kraken']['XLTC']['reserved_balance']+$wallet_params['BtcTurk']['LTC']['reserved_balance'];
  $coin_totals[0]['LTC']['price']=$btcturk_prices['LTCTRY'];

  $coin_totals[0]['XRP']['whole_balance']=$wallet_params['Kraken']['XXRP']['whole_balance']+$wallet_params['BtcTurk']['XRP']['whole_balance'];
  $coin_totals[0]['XRP']['avaiable_balance']=$wallet_params['Kraken']['XXRP']['avaiable_balance']+$wallet_params['BtcTurk']['XRP']['avaiable_balance'];
  $coin_totals[0]['XRP']['reserved_balance']=$wallet_params['Kraken']['XXRP']['reserved_balance']+$wallet_params['BtcTurk']['XRP']['reserved_balance'];
  $coin_totals[0]['XRP']['price']=$btcturk_prices['XRPTRY'];

  $coin_totals[0]['XLM']['whole_balance']=$wallet_params['Kraken']['XXLM']['whole_balance']+$wallet_params['BtcTurk']['XLM']['whole_balance'];
  $coin_totals[0]['XLM']['avaiable_balance']=$wallet_params['Kraken']['XXLM']['avaiable_balance']+$wallet_params['BtcTurk']['XLM']['avaiable_balance'];
  $coin_totals[0]['XLM']['reserved_balance']=$wallet_params['Kraken']['XXLM']['reserved_balance']+$wallet_params['BtcTurk']['XLM']['reserved_balance'];
  $coin_totals[0]['XLM']['price']=$btcturk_prices['XLMTRY'];


  $coin_totals[0]['USDT']['whole_balance']=$wallet_params['Kraken']['USDT']['whole_balance']+$wallet_params['BtcTurk']['USDT']['whole_balance'];
  $coin_totals[0]['USDT']['avaiable_balance']=$wallet_params['Kraken']['USDT']['avaiable_balance']+$wallet_params['BtcTurk']['USDT']['avaiable_balance'];
  $coin_totals[0]['USDT']['reserved_balance']=$wallet_params['Kraken']['USDT']['reserved_balance']+$wallet_params['BtcTurk']['USDT']['reserved_balance'];
  $coin_totals[0]['USDT']['price']=$btcturk_prices['USDTTRY'];

  $coin_totals[0]['USD']['whole_balance']=$wallet_params['Kraken']['ZUSD']['whole_balance'];
  $coin_totals[0]['USD']['avaiable_balance']=$wallet_params['Kraken']['ZUSD']['avaiable_balance'];
  $coin_totals[0]['USD']['reserved_balance']=$wallet_params['Kraken']['ZUSD']['reserved_balance'];

  $coin_totals[0]['EUR']['whole_balance']=$wallet_params['Kraken']['ZEUR']['whole_balance'];
  $coin_totals[0]['EUR']['avaiable_balance']=$wallet_params['Kraken']['ZEUR']['avaiable_balance'];
  $coin_totals[0]['EUR']['reserved_balance']=$wallet_params['Kraken']['ZEUR']['reserved_balance'];

  $coin_totals[0]['TRY']['whole_balance']=$wallet_params['BtcTurk']['TRY']['whole_balance'];
  $coin_totals[0]['TRY']['avaiable_balance']=$wallet_params['BtcTurk']['TRY']['avaiable_balance'];
  $coin_totals[0]['TRY']['reserved_balance']=$wallet_params['BtcTurk']['TRY']['reserved_balance'];
