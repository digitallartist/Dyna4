...
try {
$kraken_withdraw = $kraken_connect->getTradeVolume('XXBTZUSD');

$refid=$kraken_withdraw->getFeesMaker();
var_dump($kraken_withdraw);
} catch (Exception $e) {
    echo $e->getMessage();
}
...
/*
try {
$kraken_withdraw = $kraken_connect->makeWithdraw('currency','DASH','Btcturk_Dash_Mustafa','7.5');
