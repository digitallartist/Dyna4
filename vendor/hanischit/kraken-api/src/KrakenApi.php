...
use HanischIt\KrakenApi\Call\WithdrawFunds\WithdrawFundsRequest;
use HanischIt\KrakenApi\Call\WithdrawInfo\WithdrawInfoRequest;
use HanischIt\KrakenApi\Call\WithdrawStatus\WithdrawStatusRequest;
...
class KrakenApi
{
    ...
    public function makeWithdraw(
        ...
        $WithdrawFundsRequest = new WithdrawFundsRequest(
            $aclass,
            $asset,
            $key,
            $amount);

        return $this->doRequest($WithdrawFundsRequest);
    }
	...
	public function withdrawInfo(
        ...
        $WithdrawInfoRequest = new WithdrawInfoRequest(
            $aclass,
            $currency,
            $key,
            $amount);

        return $this->doRequest($WithdrawInfoRequest);
    }
	
	
	
	   public function getWithdrawStatus($aclass = 'currency',
        $asset = 'DASH',
        $method = null)
    {
        $withdrawStatus = new WithdrawStatusRequest($aclass, $asset, $method);

        return $this->doRequest($withdrawStatus);
    }
	...
	/*
       ...
       $aclass = 'currency',
        ...
        $withdrawStatusRequest = new WithdrawStatusRequest(
			$method,
			$aclass,
			$asset,
			$refid,
        ...
        return $this->doRequest($withdrawStatusRequest);
    }
	*/
	/*
	public function getWithdrawStatus(
